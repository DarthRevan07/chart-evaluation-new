 ...
 * Handles loading and parsing of question annotation data from question_annotate_run2.json
...
class AnnotationDataLoader {
    ...
    async loadAnnotationData() {
        try {
            const response = await fetch('./question_annotate_run2_filtered.json');
            if (!response.ok) {
